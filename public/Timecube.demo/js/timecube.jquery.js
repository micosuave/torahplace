        ...
        base.init = function(){
        	...
        	$(base.options.data).each(function(index, d){
				...
				if(base.options.showDate){
					base.eventDivs[index].html("<span class='date'>" + monthNames[d.startDate.getUTCMonth()] + " " + d.startDate.getUTCDate() + ", " + d.startDate.getUTCFullYear() + "</span><h1>" + d.title + "</h1><p>" + d.description + "</p><embed src=" + d.source + ">" );
				} else {
