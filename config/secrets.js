...
module.exports = {
  ...
  db: process.env.MONGODB || process.env.MONGOLAB_URI || 'mongodb://lexspace.net:27017/',
  db2: process.env.MONGOLAB_ALT_URI,
  ...
  linkedin: {
    clientID: process.env.LINKEDIN_CLIENT_ID || '77chexmowru601',
    clientSecret: process.env.LINKEDIN_CLIENT_SECRET || 'szdC8lN2s2SuMSy8',
    callbackURL: '/auth/linkedin/callback' || '/auth/linkedin/callback',
